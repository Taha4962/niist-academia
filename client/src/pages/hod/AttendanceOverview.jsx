...
const AttendanceOverview = () => {
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm overflow-hidden border border-gray-100 dark:border-gray-700 min-h-[400px]">
      <div className="h-12 bg-[#D97706] flex items-center px-6">
        <h2 className="text-white font-semibold tracking-wide">NIIST Academia - HOD Panel</h2>
      </div>
      <div className="p-8 flex flex-col items-center justify-center min-h-[300px] text-center">
        <div className="text-4xl mb-6">🚧</div>
        <h1 className="text-3xl font-bold text-niist-navy dark:text-gray-100 mb-4 tracking-tight">Attendance Overview</h1>
